    ...
    if (!is_wp_error($terms)) {
        ...
        if ($count > 0) {
            ...
            foreach ($terms as $term) {
                ...
                if (empty($attachment)) {
                    $img_url = 'https://via.placeholder.com/360x120';
                    $img_width = '360';
                    $img_height = '120';
                }
            ...
            if (!is_wp_error($taxonomy)) {
                ...
                foreach ($taxonomy as $term) {
                    ...
                    if ($homey_grid_type == 'grid_v1') {
                        ...
                        if (empty($attachment)) {
                            $img_url = 'https://via.placeholder.com/555x360';
                            $img_width = '555';
                            $img_height = '360';
                        } else {
                            $img_url = $attachment['0'];
                        ...
                        if (empty($attachment)) {
                            $img_url = 'https://via.placeholder.com/360x360';
                            $img_width = '360';
                            $img_height = '360';
                        } else {
                            $img_url = $attachment['0'];
                        ...
                        if ($i == 1 || $i == 6) {
                            ...
                            if (empty($attachment)) {
                                $img_url = 'https://via.placeholder.com/555x262';
                                $img_width = '555';
                                $img_height = '262';
                            } else {
                                $img_url = $attachment['0'];
