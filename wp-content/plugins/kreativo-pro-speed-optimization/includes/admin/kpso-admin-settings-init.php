...
?>
	...
	<div class="kpftc-desc"><b>Kreativo Pro Speed Optimization</b> is the complimentary plugin for <a style="color:#444;" href="https://www.kreativopro.com/" target="_blank">Kreativo Pro</a> customers.</div>
...
<?php
		...
		{
			echo '<div class="notice notice-success is-dismissible"><p>Main Plugin settings have been saved! Clear <b>WP Rocket</b> or <b>Autoptimize</b> cache now.</p></div>';
		}
		...
		{
			echo '<div class="notice notice-info is-dismissible"><p>Default Plugin Settings have been restored!</p></div>';
		}
		...
		<tbody>
			<tr>
				...
				<td>
					...
					<small class="description kp-code-desc">This plugin is licensed by Kreativo Pro LLC.</small><br>
				</td>
			</tr>
		</tbody>
		</table>
		...
		<ol>
			...
			<li>Only a certified Kreativo Pro WordPress expert can access the plugin settings.</li>
			<li>License clears itself out every 6 hours but plugin keeps running as configured.</li>
		</ol>
	</form>
