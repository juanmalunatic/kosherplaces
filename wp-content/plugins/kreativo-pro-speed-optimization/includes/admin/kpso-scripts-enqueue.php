...
{	
	...
	wp_register_style( 'kp-admin-css', KPSO_DIR_URL . 'assets/css/kpso-backend.css');
	wp_register_script( 'kp-admin-js', KPSO_DIR_URL . 'assets/js/kpso-backend.js');
	
	if( 'settings_page_kpso' == KPSO_PLUGIN_SLUG )
	{
		wp_enqueue_style( 'kp-admin-css' );
		wp_enqueue_script( 'kp-admin-js' );
	}
}
