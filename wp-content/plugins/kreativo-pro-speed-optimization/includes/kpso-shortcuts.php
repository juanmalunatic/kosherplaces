...
function kpso_plugin_row_meta( $links_array, $plugin_file_name, $plugin_data, $status )
{
	...
	{
        $links_array[] = '<a href="https://www.kreativopro.com/plans/" target="_blank" style="color:#93003c;font-weight:bold;">WordPress Speed Maintenance Service</a>';
    }
    return $links_array;
}
...
function kpso_change_admin_footer ( $hooks )
{
	if( 'settings_page_kpso' == KPSO_PLUGIN_SLUG )
		echo '<b><a href="https://www.kreativopro.com/plans/" target="_blank" style="color:#d30c5c;text-decoration:none">WordPress Speed Maintenance Service &#8594;</a></b>';
	else
		echo $hooks;
}
