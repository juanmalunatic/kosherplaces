...
// Replace pluggable function homey_scripts() from wp-content/themes/homey/inc/register-scripts.php
...
function homey_scripts()
{
    ...
    //JM: Change
    // get_stylesheet_directory_uri gives us the child theme's location
    wp_enqueue_script(
        'homey-ajax-calls',
        get_stylesheet_directory_uri() . '/js/homey-ajax.js',
