...
if( !function_exists('listing_submission_filter')) {
    function listing_submission_filter($new_listing) {
        ...
        if( $listing_id > 0 ) {
            ...
            if( $submission_action == 'homey_add_listing' ) {
                $post_status_text_user = "Your listing status is published";
                $post_status_text_admin = "This listing status is published";

                if( ($listings_admin_approved != 0 && !homey_is_admin())) {
                    $post_status_text_user = "Your listing status is pending for admin approval";
                    $post_status_text_admin = "This listing status is in need to be approved from you.";
                }
...
if ( !function_exists( 'homey_create_invoice_print' ) ) {
    function homey_create_invoice_print() {
        ...
        <div class="invoice-detail block">
            ...
            </div><!-- invoice-footer -->dashboard-submission.php
            <?php } ?>
